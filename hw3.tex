...
Define $\psi$:
\[ \psi(x,y) = \begin{cases} 
  \phi_x(0)      &\text{if } \phi_x(z) \downarrow \\
  \uparrow      &\text{otherwise} \end{cases}
\]
By the S-m-n Theorem there exists comp. 1-1 func. s.t.
	\[\phi_{f(x)}(y) = \psi(x,y)\]
...
Define $\psi$:
\[ \psi(x,y) = \begin{cases} 
  0             &\text{if } \phi_x(z) \downarrow \text{f.all } z \le y \\
  \uparrow      &\text{otherwise} \end{cases}
\]
By the S-m-n Theorem there exists comp. 1-1 func. s.t.
	\[\phi_{f(x)}(y) = \psi(x,y)\]
