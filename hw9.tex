...
disappears immediately, as an inconsistent theory can prove anything.
%both $\PA$ and $\PA^\bot$ are inconsistent,
...
If we insist on the ``intuitive solution''
(i.e. $\PA$ consistent and $\PA^\bot$ inconsistent), 
we can resolve this paradox by moving into a larger universe of
