...
\begin{align*}
  ...
  &\exists z \varphi( \vec{x} , y ,z) \\ %FIXME: add underlines
...
\begin{proof}
  Let 
  \iffalse %FIXME: compile error
  \[
  diag(n) =
  \begin{cases}
   \gn{\forall y ( y=n \rigtarrow \sigma(y))} % FIXME: Underline n
  ...
  $G = \forall y \left( y = n \rightarrow \psi(y) \right)$ %FIXME: underline n
